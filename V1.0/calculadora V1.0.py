# -*- coding: utf-8 -*-
"""
Created on Sat Jun 27 17:06:12 2020
...
Boton0 = Button(ventana,text="0",fg="blue", bg=color_boton,width=ancho_boton,
...
BotonMult = Button(ventana,text="x",bg=color_boton,width=ancho_boton,
...
Pantalla = Entry(ventana,font=("arial",20,"bold"),width=22,
                 borderwidth=10,background="salmon",textvariable=texto_pantalla)
